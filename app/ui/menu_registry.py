...
MENU_SCHEMA = [
    ...
    {"id": "3d_printer_cam", "text": "3D printer cam", "image": "camera.png", "action": "3d_printer_cam"},
    {
        ...
        "screen": [
            ...
            {"id": "verify_ssl_on_trusted_sources", "text": "SSL", "image": "shield.png", "action": "verify_ssl_on_trusted_sources"},
            {"id": "media_show_titles", "text": "Toon media titels", "image": "text.png", "action": "media_show_titles"},
            {"id": "media_sanitize_titles", "text": "Kort titels in", "image": "text.png", "action": "media_sanitize_titles"},
